...
public class JumpToDialog extends DialogWindow {
	...
	public JumpToDialog (final IMediaItemDb db, final AtomicReference<String> savedSearchTerm) {
	...
	public static JumpResult show (final WindowBasedTextGUI owner, final IMediaItemDb db, final SessionState sessionState) {
