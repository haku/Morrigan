...
//	- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	...
	public static void incTrackStartCnt (IMediaItemList mtl, MediaItem track, long n) {
	...
	public static void incTrackEndCnt (IMediaItemList mtl, MediaItem track, long n) {
		track.setEndCount(track.getEndCount() + n);
		mtl.getChangeEventCaller().mediaItemsUpdated(track);
		mtl.setDirtyState(DirtyState.METADATA);
	}

	public static void setTrackStartCnt (IMediaItemList mtl, MediaItem track, long n) {
		track.setStartCount(n);
		mtl.getChangeEventCaller().mediaItemsUpdated(track);
		mtl.setDirtyState(DirtyState.METADATA);
	}

	public static void setTrackEndCnt (IMediaItemList mtl, MediaItem track, long n) {
		track.setEndCount(n);
		mtl.getChangeEventCaller().mediaItemsUpdated(track);
		mtl.setDirtyState(DirtyState.METADATA);
	}

	public static void incTrackStartCnt (IMediaItemList mtl, MediaItem track) {
	...
	public static void incTrackEndCnt (IMediaItemList mtl, MediaItem track) {
		track.setEndCount(track.getEndCount() + 1);
		mtl.getChangeEventCaller().mediaItemsUpdated(track);
		mtl.setDirtyState(DirtyState.METADATA);
	}

	public static void setTrackDuration (IMediaItemList mtl, MediaItem track, int duration) {
		track.setDuration(duration);
		mtl.getChangeEventCaller().mediaItemsUpdated(track);
		mtl.setDirtyState(DirtyState.METADATA);
	}

	public static void setDateLastPlayed (IMediaItemList mtl, MediaItem track, Date date) {
