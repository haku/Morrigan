...
import morrigan.model.media.EphemeralMediaList;
...
public abstract class RpcMediaList extends EphemeralMediaList {
	...
	private static FileExistance convertExistance(final mediatoad.rpc.MediaToadProto.FileExistance existance) {
		switch (existance) {
		case EXISTS:
