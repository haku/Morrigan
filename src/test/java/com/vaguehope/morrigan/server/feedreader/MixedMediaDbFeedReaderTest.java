...
//		assertEquals(7575894L, item.getFileSize());
		...
		assertEquals("892fde64e2af9ac6390e35b2af05326b", item.getMd5().toString(16));
		assertEquals("8843d7f92416211de9ebb963ff4ce28125932878", item.getSha1().toString(16));
		...
		assertEquals(MediaItem.MediaType.TRACK, item.getMediaType());
