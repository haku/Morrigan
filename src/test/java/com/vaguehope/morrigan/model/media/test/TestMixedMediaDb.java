...
import com.vaguehope.morrigan.model.media.internal.db.mmdb.MixedMediaSqliteLayerInner;
...
public class TestMixedMediaDb extends LocalMediaDb {
	...
	public TestMixedMediaDb (final String name, final boolean autoCommit) throws DbException, MorriganException {
		...
		setDbLayer(new MixedMediaSqliteLayerInner("file:" + name + "?mode=memory&cache=shared", autoCommit, itemFactory));
		read();
	}
