...
public class QueueCursorAdapter extends CursorAdapter {

	private final LayoutInflater layoutInflater;

	private final QueueCursorReader cursorReader = new QueueCursorReader();

	public QueueCursorAdapter (final Context context) {
